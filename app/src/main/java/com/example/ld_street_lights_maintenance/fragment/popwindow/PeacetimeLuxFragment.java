...
public class PeacetimeLuxFragment extends BaseFragment implements OnChartValueSelectedListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View rootView = inflater.inflate(R.layout.fr_peacetime_lux, null);
    ...
    private void initChart(View rootView) {
        lineChart = rootView.findViewById(R.id.chart_peacetime_lux);
